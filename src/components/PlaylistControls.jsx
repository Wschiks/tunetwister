...
export default function PlaylistControls({token, deviceId, currentTrackUri, startNewSong,}) {
    ...
    const nextSongRandom = startNewSong; // now this works
    ...
    return (
        <div className="flex gap-2 mb-4 justify-center">
            ...
            <button
                className="inline-flex h-12 items-center justify-center rounded-md bg-neutral-950 px-6 font-medium text-neutral-50 shadow-lg shadow-neutral-500/20 transition active:scale-95"
                onClick={nextSongRandom} // calls startNewSong
            >
                next song
            </button>
        </div>
